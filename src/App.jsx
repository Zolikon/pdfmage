  ...
  return (
    <>
      <div className="flex flex-col h-full w-full">
        <header className=" bg-gradient-to-b from-[#778599] to-[#699de7]  w-full h-1/5">
      ...
      <dialog ref={dialogRef}>
        <div className="h-4/5 w-full p-3 flex flex-col items-center justify-between bg-gradient-to-b bg-[#699de7]">
          ...
          <div className="font-semibold flex-grow sm:text-2xl px-12">
            ...
            <div className="flex flex-col items-start border-2 m-2 p-2 border-stone-800 rounded-lg hover:border-4">
